...
function usage()
{
    echo "Usage:"
    echo -e "\tupdate:"
	echo -e "\t\t$PROGNAME -a|--action update -s|--source [source_code_path] -d|--dest [dest_path] -l|--list [to_update_file_list] -h|--help"
	echo -e "\trollback:"
	echo -e "\t\t$PROGNAME -a|--action rollback -t|--timestamp [timestamp] -d|--dest [dest_path] -l|--list [to_update_file_list] -h|--help"
	exit
}
